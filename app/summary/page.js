...
export default function SummaryPage() {
  ...
  const isCalloutBooking = serviceId === "upholstery" || (serviceId === "carpets" && isCarpetCallout(selections));
        ...
        <div className="w-full rounded-[28px] border border-[#1f4b8f]/14 bg-white p-6 shadow-[0_24px_80px_rgba(31,75,143,0.12)]">
          ...
          <div className="mt-6 rounded-2xl border border-[#1f4b8f]/18 bg-[#eef4ff] p-4">
            ...
            <div className="mt-4 border-t border-white/10 pt-4">
              ...
              ) : serviceId === "carpets" && isCalloutBooking ? (
                null
              ) : null}
            </div>
          </div>
          ...
          {(serviceId === "footwear" || isLooseCarpetDropOff) && !contactState.open && !showDirectFootwearOptions && (
